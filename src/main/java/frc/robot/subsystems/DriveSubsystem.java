...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    ...
    AutoBuilder.configureHolonomic(
                  ...
                  this::getModuleStates, // ChassisSpeeds supplier. MUST BE ROBOT RELATIVE
  ...
  public ChassisSpeeds getModuleStates(){
    ...
    double m_currentRotation = m_rotLimiter.calculate(m_gyro.getAngle(IMUAxis.kZ));
    double xSpeedDelivered = xSpeedCommanded * DriveConstants.kMaxSpeedMetersPerSecond;
    double ySpeedDelivered = ySpeedCommanded * DriveConstants.kMaxSpeedMetersPerSecond;
    double rotDelivered = m_currentRotation * DriveConstants.kMaxAngularSpeed;
    return ChassisSpeeds.fromRobotRelativeSpeeds(xSpeedDelivered, ySpeedDelivered, rotDelivered, Rotation2d.fromDegrees(m_gyro.getAngle(IMUAxis.kZ)));
